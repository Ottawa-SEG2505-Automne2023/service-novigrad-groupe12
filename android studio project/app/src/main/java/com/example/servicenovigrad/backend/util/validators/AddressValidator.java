...
public class AddressValidator extends FieldValidator {
    // Pattern matches: "[n-digit number] [set of words accepting numbers, spaces & apostrophes (street name)], [set of words accepting numbers, spaces & apostrophes (city name)]"
